"""
Django settings for sql_contest_system project.
...
ALLOWED_HOSTS = ['trjudge.cs.msu.ru', 'localhost']
...
ROOT_URLCONF = 'sql_contest_system.urls'
...
WSGI_APPLICATION = 'sql_contest_system.wsgi.application'
